...
The committed docs/static/securevu-api.yaml is the output of this script. It is
...
stays in lockstep with ``securevu/api/auth.py`` instead of duplicating them.
...
from securevu.api.auth import require_admin_by_default

logging.basicConfig(level=logging.INFO, format="%(message)s")
logger = logging.getLogger("generate_api_auth_spec")

REPO_ROOT = Path(__file__).resolve().parent
OUTPUT_SPEC = REPO_ROOT / "docs" / "static" / "securevu-api.yaml"
...
SPEC_TITLE = ""
SPEC_SERVERS = [
    {"url": "https://demo.securevu.io/api"},
...
ADMIN_SCHEME = "securevuAdminAuth"
USER_SCHEME = "securevuUserAuth"
...
SECURITY_SCHEMES = {
    ADMIN_SCHEME: {
        ...
        "description": (
            ...
            "proxy auth headers (remote-user / remote-role) when SecureVu runs "
    ...
    USER_SCHEME: {
        ...
        "description": (
            ...
            "headers when SecureVu runs behind an authenticating reverse proxy."
        ),
    },
}
...
def build_app() -> FastAPI:
    ...
    This mirrors the router set wired up in securevu.api.fastapi_app. It omits
...
def read_exempt_rules() -> tuple[set[str], tuple[str, ...]]:
    ...
    securevu/api/auth.py automatically.
    """
