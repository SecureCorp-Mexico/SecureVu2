...
Ensure HTTP is enabled in the camera's advanced network settings. To use two way talk with SecureVu, see the [Live view documentation](/configuration/live#two-way-talk).
