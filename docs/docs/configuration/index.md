...
For Home Assistant App installations, the config file should be at `/addon_configs/<addon_directory>/config.yml`, where `<addon_directory>` is specific to the variant of the SecureVu App you are running. See the list of directories [here](#accessing-app-config-dir).
