...
1. **Enable face recognition** in your configuration file and restart SecureVu.
...
1. Ensure `person` is being _detected_. A `person` will automatically be scanned by SecureVu for a face. Any detected faces will appear in the Recent Recognitions tab in the SecureVu UI's Face Library.
...
### SecureVu misidentified a face. Can I tell it that a face is "not" a specific person?
