...
Before requesting your first model, you will need to upload and verify at least 10 images to SecureVu+. The more images you upload, annotate, and verify the better your results will be. Most users start to see very good results once they have at least 100 verified images per camera. Keep in mind that varying conditions should be included. You will want images from cloudy days, sunny days, dawn, dusk, and night. Refer to the [integration docs](../integrations/plus.md#generate-an-api-key) for instructions on how to easily submit images to SecureVu+ directly from SecureVu.
...
You will receive an email notification when your SecureVu+ model is ready.
![Model Ready Email](/img/plus/model-ready-email.jpg)

Models available in SecureVu+ can be used with a special model path. No other information needs to be configured because it fetches the remaining config from SecureVu+ automatically.

<ConfigTabs>
<TabItem value="ui">

Navigate to <NavPath path="Settings > System > Detectors and model" />. In the **Detection Model** section, choose the **SecureVu+** tab. Select your new SecureVu+ model from the **Available SecureVu+ models** dropdown, then click **Save**. Restart SecureVu to apply the change.
...
When setting the plus model id, all other fields should be removed as these are configured automatically with the SecureVu+ model config
