"""Load JSON schema from SecureVu's Pydantic config models."""

from typing import Any


def load_schema() -> dict[str, Any]:
    """Generate and return the full JSON schema for SecureVuConfig."""
    from securevu.config.config import SecureVuConfig
    from securevu.util.schema import get_config_schema

    return get_config_schema(SecureVuConfig)
