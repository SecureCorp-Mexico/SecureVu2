...
1. **Check for existing discussion.** Search [feature requests](https://github.com/SecureCorp-Mexico/SecureVu2/issues) and [discussions](https://github.com/SecureCorp-Mexico/SecureVu2/discussions) to see if it's been proposed or discussed. Feature requests tagged with "planned" are on our radar — we plan to get to them, but we don't maintain a public roadmap or timeline. Check in with us first if you have interest in contributing to one.
...
SecureVu uses [Weblate](https://hosted.weblate.org/projects/frigate-nvr/) for managing language translations. If you'd like to help translate SecureVu into your language:

1. Visit the [SecureVu project on Weblate](https://hosted.weblate.org/projects/frigate-nvr/).
...
- [Discussions, Support, and Bug Reports](https://github.com/SecureCorp-Mexico/SecureVu2/discussions)
- [Feature Requests](https://github.com/SecureCorp-Mexico/SecureVu2/issues)
