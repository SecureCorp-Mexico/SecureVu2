...
from securevu.jobs.manager import (
    get_job_by_id,
    set_current_job,
)
from securevu.jobs.motion_search_batch import (
    build_segment_time_map,
    coalesce_runs,
    stream_time_to_absolute,
)
from securevu.jobs.motion_search_decode import (
    iter_vod_frames,
...
def resolve_internal_port(config: SecureVuConfig) -> int:
