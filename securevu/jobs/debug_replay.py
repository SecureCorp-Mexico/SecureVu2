...
session. The DebugReplayManager (in securevu.debug_replay) owns session
...
from securevu.const import REPLAY_CAMERA_PREFIX, REPLAY_DIR
from securevu.jobs.export import JobStatePublisher
from securevu.jobs.job import Job
from securevu.jobs.manager import job_is_running, set_current_job
from securevu.models import Export, Recordings
from securevu.types import JobStatusTypesEnum
from securevu.util.ffmpeg import run_ffmpeg_with_progress
...
class ExportDebugReplaySource(DebugReplaySource):
    ...
    def __init__(self, export: Export, duration: float) -> None:
        ...
        # Export.date is declared DateTimeField but SecureVu writes raw unix
...
class DebugReplayJobRunner(threading.Thread):
    ...
    def __init__(
        ...
        self.job = job
        self.source = source
        self.securevu_config = securevu_config
    ...
    def run(self) -> None:
        ...
        try:
            ...
            ffmpeg_cmd = [
                self.securevu_config.ffmpeg.ffmpeg_path,
                "-hide_banner",
                "-y",
                *input_args,
                "-c",
            ...
            self.replay_manager.publish_camera(
                ...
                clip_path=clip_path,
                securevu_config=self.securevu_config,
...
def start_debug_replay_job(
    *,
    ...
    if source.source_camera not in securevu_config.cameras:
