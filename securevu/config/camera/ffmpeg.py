...
from securevu.const import DEFAULT_FFMPEG_VERSION, INCLUDED_FFMPEG_VERSIONS
...
# https://github.com/SecureCorp-Mexico/SecureVu2/issues/5659
...
class FfmpegOutputArgsConfig(SecureVuBaseModel):
...
class FfmpegConfig(SecureVuBaseModel):
...
class CameraInput(SecureVuBaseModel):
