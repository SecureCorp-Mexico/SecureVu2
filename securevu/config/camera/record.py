...
from securevu.const import MAX_PRE_CAPTURE
...
class RecordRetainConfig(SecureVuBaseModel):
...
class ReviewRetainConfig(SecureVuBaseModel):
    days: float = Field(default=10, ge=0, title="Default retention period.")
    mode: RetainModeEnum = Field(default=RetainModeEnum.motion, title="Retain mode.")


class EventsConfig(SecureVuBaseModel):
