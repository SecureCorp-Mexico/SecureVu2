...
class AlertsConfig(SecureVuBaseModel):
    """Configure alerts"""
...
class DetectionsConfig(SecureVuBaseModel):
...
class GenAIReviewConfig(SecureVuBaseModel):
    enabled: bool = Field(
        default=False,
...
class ReviewConfig(SecureVuBaseModel):
    """Configure reviews"""
