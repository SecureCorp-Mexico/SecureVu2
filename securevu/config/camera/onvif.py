...
class PtzAutotrackConfig(SecureVuBaseModel):
    ...
    calibrate_on_startup: bool = Field(
        ...
        description="Measure PTZ motor speeds on startup to improve tracking accuracy. SecureVu will update config with movement_weights after calibration.",
    )
...
class OnvifConfig(SecureVuBaseModel):
    ...
    ignore_time_mismatch: bool = Field(
        ...
        description="Ignore time synchronization differences between camera and SecureVu server for ONVIF communication.",
    )
