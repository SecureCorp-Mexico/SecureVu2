...
from securevu.const import CACHE_DIR, CACHE_SEGMENT_FORMAT, REGEX_CAMERA_NAME
...
class CameraConfig(SecureVuBaseModel):
    name: str | None = Field(
        None,
        title="Camera name",
    ...
    friendly_name: str | None = Field(
        None,
        title="Friendly name",
        description="Camera friendly name used in the SecureVu UI",
    )
