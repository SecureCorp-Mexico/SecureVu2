...
class MotionMaskConfig(SecureVuBaseModel):
    """Configuration for a single motion mask."""

    friendly_name: str | None = Field(
        default=None,
        title="Friendly name",
        description="A friendly name for this motion mask used in the SecureVu UI",
    )
    enabled: bool = Field(
        default=True,
        title="Enabled",
...
class ObjectMaskConfig(SecureVuBaseModel):
    """Configuration for a single object mask."""

    friendly_name: str | None = Field(
        default=None,
        title="Friendly name",
        description="A friendly name for this object mask used in the SecureVu UI",
    )
    enabled: bool = Field(
        default=True,
        title="Enabled",
