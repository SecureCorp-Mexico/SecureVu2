...
class FilterConfig(SecureVuBaseModel):
...
class GenAIObjectTriggerConfig(SecureVuBaseModel):
...
class GenAIObjectConfig(SecureVuBaseModel):
...
class ObjectConfig(SecureVuBaseModel):
