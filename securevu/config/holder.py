...
from .config import SecureVuConfig
...
class ConfigHolder:
    ...
    /api/config/set re-parses yaml into a brand new SecureVuConfig instead of
    ...
    one place (securevu.api.config_util.swap_runtime_config) and everyone else
    only reads.
    """
    ...
    def set(self, config: SecureVuConfig) -> None:
