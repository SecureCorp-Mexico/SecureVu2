...
class MonitoredProcess:
    ...
    name: str
    process: SecureVuProcess
    factory: Callable[[], SecureVuProcess]
    on_restart: Callable[[SecureVuProcess], None] | None = None
...
class SecureVuWatchdog(threading.Thread):
    def __init__(
        self,
        detectors: dict[str, ObjectDetectProcess],
        stop_event: MpEvent,
    ):
        super().__init__(name="securevu_watchdog")
    ...
    def register(
        ...
        """Register a SecureVuProcess for monitoring and automatic restart."""
