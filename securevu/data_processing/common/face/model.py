...
from securevu.embeddings.onnx.face_embedding import ArcfaceEmbedding, FaceNetEmbedding
from securevu.log import redirect_output_to_logger
...
class FaceNetRecognizer(FaceRecognizer):
    def __init__(self, config: SecureVuConfig):
