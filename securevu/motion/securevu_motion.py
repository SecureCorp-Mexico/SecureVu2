...
from securevu.config.config import RuntimeMotionConfig
from securevu.motion import MotionDetector
from securevu.util.image import grab_cv2_contours


class SecureVuMotionDetector(MotionDetector):
    def __init__(
        self,
    ...
    def detect(self, frame: np.ndarray) -> list:
        ...
        if self.frame_counter < 30:
            ...
            if self.save_images:
                ...
                cv2.imwrite(
                    f"debug/frames/securevu-{self.frame_counter}.jpg", thresh_dilated
                )
