...
from securevu.const import FREQUENCY_STATS_POINTS
from securevu.stats.prometheus import update_metrics
from securevu.stats.util import stats_snapshot
...
class StatsEmitter(threading.Thread):
    def __init__(
        ...
        super().__init__(name="securevu_stats_emitter")
        self.config = config
