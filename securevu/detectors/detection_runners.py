...
from securevu.util.model import get_ort_providers
from securevu.util.rknn_converter import auto_convert_model, is_rknn_compatible
...
class ONNXModelRunner(BaseModelRunner):
    ...
    def is_migraphx_complex_model(model_type: str) -> bool:
        # Import here to avoid circular imports
        from securevu.detectors.detector_config import ModelTypeEnum
        from securevu.embeddings.types import EnrichmentModelTypeEnum
