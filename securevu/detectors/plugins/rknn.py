...
from securevu.const import MODEL_CACHE_DIR, SUPPORTED_RK_SOCS
from securevu.detectors.detection_api import DetectionApi
from securevu.detectors.detection_runners import RKNNModelRunner
from securevu.detectors.detector_config import BaseDetectorConfig, ModelTypeEnum
from securevu.util.model import post_process_yolo, xyxy_to_xywh_for_nms
from securevu.util.rknn_converter import auto_convert_model
...
supported_models = {
    ModelTypeEnum.yologeneric: "^securevu-fp16-yolov9-[cemst]$",
