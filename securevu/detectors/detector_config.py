...
from securevu.const import DEFAULT_ATTRIBUTE_LABEL_MAP, MODEL_CACHE_DIR
from securevu.plus import PlusApi
from securevu.util.builtin import generate_color_palette, load_labels
...
class ModelConfig(BaseModel):
    path: str | None = Field(
        ...
        description="Path to a custom detection model file (or plus://<model_id> for SecureVu+ models).",
    )
