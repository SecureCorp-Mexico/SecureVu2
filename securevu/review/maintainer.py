...
from securevu.comms.review_updater import ReviewDataPublisher
...
from securevu.track.object_processing import ManualEventState, TrackedObject
from securevu.util.image import SharedMemoryFrameManager, calculate_16_9_crop
...
class ReviewSegmentMaintainer(threading.Thread):
    ...
    def __init__(self, config: SecureVuConfig, stop_event: MpEvent):
