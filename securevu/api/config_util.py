...
def publish_camera_section_updates(
    app: FastAPI, config: SecureVuConfig, update_type: CameraConfigUpdateEnum
) -> None:
...
def swap_runtime_config(app: FastAPI, config: SecureVuConfig) -> None:
    ...
    SecureVuConfig and must rebind the same set of references, or the API and
