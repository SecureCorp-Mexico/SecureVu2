...
from securevu.api import app as main_app
...
def create_fastapi_app(
    ...
    @app.middleware("http")
    async def securevu_middleware(request: Request, call_next):
        # Before request
    ...
    if securevu_config.auth.failed_login_rate_limit is None:
        ...
        auth.rateLimiter.set_limit(securevu_config.auth.failed_login_rate_limit)
