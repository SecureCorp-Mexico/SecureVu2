...
from securevu.api.auth import deny_response_for_go2rtc_stream
...
def _request(config: SecureVuConfig) -> types.SimpleNamespace:
    return types.SimpleNamespace(app=types.SimpleNamespace(securevu_config=config))
