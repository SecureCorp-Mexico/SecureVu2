...
from securevu.jobs.manager import _completed_jobs, _current_jobs
...
class TestStartDebugReplayJob(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.securevu_config = MagicMock()
        self.securevu_config.cameras = {"front": MagicMock()}
        self.securevu_config.ffmpeg.ffmpeg_path = "/bin/true"
    ...
    def test_returns_job_id_and_marks_session_starting(self) -> None:
        ...
        with (
            patch(
                "securevu.jobs.debug_replay.query_recordings",
                return_value=self.recordings_qs,
            ),
            patch(
                "securevu.jobs.debug_replay.run_ffmpeg_with_progress",
...
class TestRunnerHappyPath(unittest.TestCase):
    ...
    def test_progress_callback_updates_job_percent(self) -> None:
        ...
        from securevu.jobs.manager import get_current_job
