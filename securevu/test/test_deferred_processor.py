...
from securevu.data_processing.real_time.api import DeferredRealtimeProcessorApi
...
from securevu.data_processing.real_time.custom_classification import (  # noqa: E402
...
class TestCustomObjectClassificationDeferred(unittest.TestCase):
    ...
    def test_drain_results_empty_when_no_model(self):
        ...
        with patch(
            "securevu.data_processing.real_time.custom_classification.write_classification_attempt"
        ):
