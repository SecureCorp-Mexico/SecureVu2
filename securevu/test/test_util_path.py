...
from securevu.const import TRIGGER_DIR
from securevu.util.path import (
...
class TestSafeJoin(unittest.TestCase):
    ...
    def test_joins_multiple_segments(self):
        self.assertEqual(
            ...
            "/media/securevu/clips/model1/dataset/none",
        )
...
class TestIsContainedIn(unittest.TestCase):
    ...
    def test_rejects_parent(self):
        self.assertFalse(is_contained_in("/media/securevu", "/media/securevu/clips"))
    ...
    def test_rejects_uncomparable_paths(self):
        self.assertFalse(is_contained_in("relative/x", "/media/securevu/clips"))
...
class TestSanitizeContainedPath(unittest.TestCase):
    ...
    def test_rejects_dot_dot_anywhere(self):
        for value in [
            "/media/securevu/clips/../../etc/passwd",
            "clips\\..\\..\\etc/passwd",
            "/media/securevu/clips/a/../../../x",
        ]:
            with self.subTest(value=value):
    ...
    def test_rejects_sibling_sharing_a_name_prefix(self):
        self.assertIsNone(
            sanitize_contained_path("/media/securevu/clips_evil/x.webp", self.base)
        )
    ...
    def test_keeps_a_valid_nested_path(self):
        self.assertEqual(
            sanitize_contained_path("/media/securevu/clips/a/b.webp", self.base),
            "/media/securevu/clips/a/b.webp",
        )
