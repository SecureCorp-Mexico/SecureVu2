"""Tests for the REGEXP function registered on the main SecureVu database.
...
from securevu.db.sqlitevecq import REGEXP_TIMEOUT_SECONDS, SqliteVecQueueDatabase
