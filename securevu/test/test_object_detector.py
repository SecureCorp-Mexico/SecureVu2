...
import securevu.detectors as detectors
import securevu.object_detection.base
from securevu.config import DetectorConfig, ModelConfig
from securevu.detectors import DetectorTypeEnum
from securevu.detectors.detector_config import InputTensorEnum
...
class TestLocalObjectDetector(unittest.TestCase):
        ...
        for det_type in detectors.api_types:
            with self.subTest(det_type=det_type):
                with patch.dict(
                    ...
                    test_obj = securevu.object_detection.base.LocalObjectDetector(
    ...
    def test_detect_raw_given_tensor_input_should_return_api_detect_raw_result(self):
        ...
        test_obj_detect = securevu.object_detection.base.LocalObjectDetector(
    ...
    @patch("securevu.object_detection.base.load_labels")
