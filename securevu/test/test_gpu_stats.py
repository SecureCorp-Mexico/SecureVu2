...
from securevu.util.services import get_amd_gpu_stats, get_intel_gpu_stats
...
class TestGpuStats(unittest.TestCase):
    ...
    @patch("securevu.stats.intel_gpu_info.intel_gpu_name_resolver.get_names")
    @patch("securevu.util.services.time.sleep")
    @patch("securevu.util.services.time.monotonic")
    @patch("securevu.util.services._read_intel_drm_fdinfo")
    @patch("securevu.util.services._enumerate_drm_devices")
    ...
    @patch("securevu.util.services._read_intel_drm_fdinfo")
    @patch("securevu.util.services._enumerate_drm_devices")
    @patch("securevu.util.services._resolve_intel_gpu_pdev")
