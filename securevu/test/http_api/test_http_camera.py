...
class TestDeleteCameraRuntimeConfig(BaseTestHttp):
    ...
    @patch("securevu.api.camera.requests.delete")
    @patch("securevu.api.camera.cleanup_camera_files")
    @patch("securevu.api.camera.cleanup_camera_db")
    @patch("securevu.api.camera.find_config_file")
