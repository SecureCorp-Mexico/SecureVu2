...
from securevu.record.export import validate_ffmpeg_args
...
class TestValidateFfmpegArgs(unittest.TestCase):
    ...
    def test_preset_file_read_rejected(self):
        ...
        self.assertRejected("-fpre securevu/../../../etc/passwd")
    ...
    def test_tee_write_rejected(self):
        ...
        self.assertRejected("-f tee [f=mpegts]/etc/securevu/x.ts")
