...
INSTALL_DIR = "/opt/securevu"
CONFIG_DIR = "/config"
DEFAULT_DB_PATH = f"{CONFIG_DIR}/securevu.db"
MODEL_CACHE_DIR = f"{CONFIG_DIR}/model_cache"
BASE_DIR = "/media/securevu"
...
PLUS_API_HOST = "https://api.securevu.io"

SHM_FRAMES_VAR = "SHM_MAX_FRAMES"

REDACTED_CREDENTIAL_SENTINEL = "__SECUREVU_SAVED_CREDENTIAL__"
...
JWT_SECRET_ENV_VAR = "SECUREVU_JWT_SECRET"
