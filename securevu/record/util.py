...
from securevu.models import Recordings, RecordingsToDelete
...
def sync_recordings(limited: bool) -> None:
    ...
    def delete_db_entries_without_file(check_timestamp: float) -> bool:
        """Delete db entries where file was deleted outside of securevu."""
    ...
    def delete_files_without_db_entry(files_on_disk: list[str]):
        """Delete files where file is not inside securevu db."""
        files_to_delete = []
