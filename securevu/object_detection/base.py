...
from securevu.comms.object_detector_signaler import (
...
from securevu.detectors import create_detector
from securevu.detectors.detector_config import (
    BaseDetectorConfig,
    InputDTypeEnum,
    ModelConfig,
)
from securevu.util.builtin import EventsPerSecond, load_labels
...
class DetectorRunner(SecureVuProcess):
    def __init__(
        self,
        name,
...
class AsyncDetectorRunner(SecureVuProcess):
    def __init__(
        self,
        name,
        detection_queue: Queue,
...
class ObjectDetectProcess:
    def __init__(
        ...
        self.detect_process: SecureVuProcess | None = None
        self.config = config
        self.detector_config = detector_config
