...
import securevu.log
from securevu.config.logger import LoggerConfig
...
class SecureVuProcess(BaseProcess):
    logger: logging.Logger

    def before_start(self) -> None:
        self.__log_queue = securevu.log.log_listener.queue
