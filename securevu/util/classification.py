...
from securevu.comms.embeddings_updater import EmbeddingsRequestEnum, EmbeddingsRequestor
from securevu.comms.inter_process import InterProcessRequestor
from securevu.config import FfmpegConfig
...
from securevu.log import redirect_output_to_logger, suppress_stderr_during
from securevu.models import Event, Recordings, ReviewSegment
from securevu.types import ModelStatusTypesEnum
from securevu.util.downloader import ModelDownloader
...
class ClassificationTrainingProcess(SecureVuProcess):
