"""GenAI client manager for SecureVu.

Manages GenAI provider clients from SecureVu config. Clients are created lazily
...
from securevu.config.camera.genai import GenAIConfig, GenAIRoleEnum
...
class GenAIClientManager:
    """Manages GenAI provider clients from SecureVu config."""
    ...
    def update_config(self, config: SecureVuConfig) -> None:
    ...
    def _get_client(self, name: str) -> "GenAIClient | None":
        ...
        from securevu.genai import PROVIDERS
