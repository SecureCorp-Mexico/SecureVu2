"""Azure OpenAI Provider for SecureVu AI.
...
from securevu.genai import register_genai_provider
from securevu.genai.plugins.openai import OpenAIClient
...
class AzureOpenAIClient(OpenAIClient):
    """Generative AI client for SecureVu using Azure OpenAI."""
