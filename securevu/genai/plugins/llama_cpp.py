"""llama.cpp Provider for SecureVu AI."""
...
from securevu.genai import GenAIClient, register_genai_provider
from securevu.genai.utils import parse_tool_calls_from_message
...
class LlamaCppClient(GenAIClient):
    """Generative AI client for SecureVu using llama.cpp server."""
