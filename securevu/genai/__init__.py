"""Generative AI module for SecureVu."""
...
from securevu.config import CameraConfig, GenAIConfig, GenAIProviderEnum
...
from securevu.util.builtin import has_non_finite_number
...
class GenAIClient:
    """Generative AI client for SecureVu."""
    ...
    def embed(
        ...
        for SecureVu semantic search compatibility.
...
def load_providers() -> None:
    ...
    for filename in os.listdir(plugins_dir):
        if filename.endswith(".py") and filename != "__init__.py":
            module_name = f"securevu.genai.plugins.{filename[:-3]}"
