...
from securevu.config import SecureVuConfig, ZoomingModeEnum
from securevu.util.builtin import find_by_key
...
class OnvifController:
    ...
    def __init__(
        self, config: SecureVuConfig, ptz_metrics: dict[str, PTZMetrics]
    ) -> None:
