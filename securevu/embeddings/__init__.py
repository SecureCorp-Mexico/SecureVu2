...
from securevu.const import CONFIG_DIR, FACE_DIR, PROCESS_PRIORITY_HIGH
...
from securevu.util.classification import kickoff_model_training
from securevu.util.path import safe_join
...
class EmbeddingProcess(SecureVuProcess):
    def __init__(
        self,
        ...
        super().__init__(
            ...
            name="securevu.embeddings_manager",
            daemon=True,
        )
        self.config = config
