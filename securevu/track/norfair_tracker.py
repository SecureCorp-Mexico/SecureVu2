...
from securevu.config import CameraConfig
from securevu.ptz.autotrack import PtzMotionEstimator
from securevu.track import ObjectTracker
from securevu.track.stationary_classifier import (
...
from securevu.util.object import average_boxes, median_of_boxes
...
def securevu_distance(detection: Detection, tracked_object: TrackedObject) -> float:
    ...
    def __init__(
        ...
        self.object_type_configs = {
            "car": {
                ...
                "distance_function": securevu_distance,
