"""Handle sending notifications for SecureVu via Firebase."""
...
from securevu.config.auth import AuthConfig
from securevu.config.camera.updater import (
    CameraConfigUpdateEnum,
    CameraConfigUpdateSubscriber,
)
from securevu.const import BASE_DIR, CONFIG_DIR
...
class WebPushClient(Communicator):
    """SecureVu wrapper for webpush client."""
    ...
    def send_notification_test(self) -> None:
        ...
        for user in self.web_pushers:
            self.send_push_notification(
                ...
                message="This is a test notification from SecureVu.",
                direct_url="/",
