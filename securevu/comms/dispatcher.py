"""Handle communication between SecureVu and other applications."""
...
from securevu.camera import PTZMetrics
from securevu.camera.activity_manager import AudioActivityManager, CameraActivityManager
from securevu.comms.base_communicator import Communicator
from securevu.comms.runtime_state import RuntimeStatePersistence
...
from securevu.models import Event, Previews, Recordings, ReviewSegment
from securevu.ptz.onvif import OnvifCommandEnum, OnvifController
from securevu.types import ModelStatusTypesEnum, TrackedObjectUpdateTypesEnum
from securevu.util.object import get_camera_regions_grid
from securevu.util.services import restart_securevu

logger = logging.getLogger(__name__)


class Dispatcher:
    """Handle communication between SecureVu and communicators."""
    ...
    def restore_runtime_state(self) -> None:
        """Replay persisted runtime overrides once SecureVu startup completes.
