...
test.describe("Mock Overrides — empty @meta", () => {
  test("mockEmpty returns []", async ({ page, securevuApp }) => {
...
test.describe("Mock Overrides — error default @meta", () => {
  ...
  test("mockError returns 500 by default", async ({ page, securevuApp }) => {
...
test.describe("Mock Overrides — error custom status @meta", () => {
  ...
  test("mockError accepts a custom status", async ({ page, securevuApp }) => {
