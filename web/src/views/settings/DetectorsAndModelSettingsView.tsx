...
const deriveInitialState = (config: SecureVuConfig): PageState => {
                        ...
                        <Popover>
                          <PopoverTrigger asChild>
                            <button
                              ...
                              aria-label={t(
                                "securevuPlus.modelInfo.filter.ariaLabel",
                              )}
                            >
                              <LuFilter
                                className={cn(
                          ...
                          <PopoverContent align="end" className="w-56">
                            <div className="space-y-3">
                              <div className="text-sm text-primary-variant">
                                {t("securevuPlus.modelInfo.filter.ariaLabel")}
                              </div>
                              ...
                              <div className="flex items-center justify-between">
                                ...
                                >
                                  {t(
                                    "securevuPlus.modelInfo.filter.fineTunedModels",
                                  )}
                                </Label>
                                <Switch
