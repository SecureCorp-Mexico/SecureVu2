...
export default function Statusbar() {
  ...
  return (
    <div
      id="statusbar"
      className="absolute bottom-0 left-0 right-0 z-10 flex h-8 w-full items-center justify-between border-t border-secondary-highlight bg-background_alt px-4 dark:text-secondary-foreground"
    >
