    ...
    >
      {firstExport && (
        <img
          ...
          src={`${baseUrl}${firstExport.thumb_path.replace("/media/securevu/", "")}`}
          alt=""
        />
      )}
      {!firstExport && (
          ...
          <>
            {exportedRecording.thumb_path.length > 0 ? (
              <img
                ...
                src={`${baseUrl}${exportedRecording.thumb_path.replace("/media/securevu/", "")}`}
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                >
                  <a
                    download
                    href={`${baseUrl}${exportedRecording.video_path.replace("/media/securevu/", "")}`}
                    onClick={(e) => e.stopPropagation()}
                  >
