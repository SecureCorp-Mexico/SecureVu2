...
export type SecureVuPlusDialogProps = {
  upload?: Event;
  dialog?: boolean;
  onClose: () => void;
...
export function SecureVuPlusDialog({
  upload,
  dialog = true,
  onClose,
  onEventUploaded,
}: SecureVuPlusDialogProps) {
  ...
  return (
    <Dialog open={true} onOpenChange={(open) => (!open ? onClose() : null)}>
      ...
      >
        <DialogHeader>
          <DialogTitle className="sr-only">Submit to SecureVu+</DialogTitle>
          <DialogDescription className="sr-only">
            Submit this snapshot to SecureVu+
          </DialogDescription>
        </DialogHeader>
